...
class "Nocturne"
local Scriptname,Version,Author,LVersion = "NocturneExpress","v1.0","Tocsin","8.6"
...
function Nocturne:LoadSpells()
	Q = {Range = 1200, Width = 80, Delay = 0.25, Speed = 1600, Collision = false, aoe = true, Type = "line"}
	W = {}
	E = {Range = 425}
	R = {Range = 2500}
end
...
function Nocturne:LoadMenu()
	self.Menu = MenuElement({type = MENU, id = "NocturneExpress", name = Scriptname})
	...
	self.Menu.ClearMode:MenuElement({id = "UseQ", name = "Q: Duskbringer", value = true})
	self.Menu.ClearMode:MenuElement({id = "UseE", name = "E: Unspeakable Horror", value = true})
	self.Menu.ClearMode:MenuElement({id = "clearActive", name = "Clear key", key = string.byte("V")})
	self.Menu:MenuElement({id = "CustomSpellCast", name = "Use custom spellcast", tooltip = "wtf problems with wrong directions", value = true})
...
function Nocturne:HasBuff(unit, buffname)
...
function Nocturne:IsReady(spell)
	return Game.CanUseSpell(spell) == 0
end

function Nocturne:CheckMana(spellSlot)
	return myHero:GetSpellData(spellSlot).mana < myHero.mana
end

function Nocturne:CanCast(spellSlot)
...
function Nocturne:CastSpell(spell,pos)
...
function Nocturne:Combo()
	...
	local target = target or (_G.SDK and _G.SDK.TargetSelector:GetTarget(1300, _G.SDK.DAMAGE_TYPE_PHYSICAL)) or (_G.GOS and _G.GOS:GetTarget(E.Range,"AD"))
...
function Nocturne:GetEnemyHeroes()
	self.EnemyHeroes = {}
...
function Nocturne:EnemyInRange(range)
	local count = 0
